...
Abstract:
A BaseViewController subclass that provides details about a purchase. The purchase contains the product identifier, transaction identifier,
 and transaction date for a regular purchase. It includes the content identifier, content version, and content length for a hosted product. It
